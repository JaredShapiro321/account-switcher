...
hulu(email, password, name, birthdayDay, birthdayMonth, birthdayYear, gender, cn, cvc, zip);

function hulu (email, password, name, birthdayDay, birthdayMonth, birthdayYear, gender, cn, expiry, cvc, zip ) {
